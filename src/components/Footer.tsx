  ...
  <footer className="bg-background border-t border-border py-12">
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid md:grid-cols-3 gap-8 mb-8">
        <div>
          <p className="font-script text-3xl text-gold mb-3">Eternal</p>
        ...
        <div>
          ...
          <div className="space-y-2">
            {["Services", "Portfolio", "Stories", "About", "Contact"].map((link) => (
              <a
                key={link}
        ...
        <div>
          ...
          <div className="space-y-2">
            {["Wedding Websites", "Digital Invitations", "RSVP Systems", "Registry Integration"].map((s) => (
      ...
      <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="font-body text-xs text-muted-foreground flex items-center gap-1">
          © 2026 Eternal. Made with <Heart size={12} className="text-gold" /> for love stories everywhere.
        </p>
