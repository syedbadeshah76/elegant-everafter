...
const WHATSAPP_URL = "https://wa.me/919999999999?text=Hi%2C%20I%27d%20love%20to%20design%20my%20love%20story%20with%20you.%20Can%20we%20chat%3F";
    ...
    <section className="py-20 bg-background relative overflow-hidden" ref={ref}>
      ...
      >
        ...
        <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">
          Ready to Tell Your <span className="text-gradient-gold italic">Love Story?</span>
        </h2>
        <p className="font-body text-muted-foreground mb-8 max-w-lg mx-auto">
          Every great love story deserves a digital experience that's equally unforgettable. Let's create yours together.
        </p>
        <a
          href={WHATSAPP_URL}
          target="_blank"
